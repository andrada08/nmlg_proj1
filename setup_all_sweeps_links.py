    ...
    for all_sweeps_folder, component_folders in mappings.items():
        ...
        for component_folder in component_folders:
            ...
            if not component_path.exists():
                print(f"  Warning: Component folder {component_path} does not exist, skipping")
                continue
            ...
            for sweep_dir in sweep_dirs:
                ...
                if link_path.exists():
                    if link_path.is_symlink():
                        ...
                        print(f"    Warning: {link_path} exists but is not a symlink, skipping")
                        continue
...
if __name__ == '__main__':
    ...
    print("\n✓ Setup complete!")
    print("\nYou can now run:")
    print("  python analyze_results.py --output-subfolder three_layer_skip_all_sweeps")
    print("  python analyze_results.py --output-subfolder four_layer_integrating_all_sweeps")
